<?php
    ...
    define('LANG_FILTER_NOT_LIKE',           'не містить');
    ...
    define('LANG_PARSER_STRING_DISPLAY_VARIANT','Варіант відображення в фільтрі');
    define('LANG_PARSER_STRING_ENTER_DEFAULT',  'Заповнити передвстановлені значення з наявних даних');
    define('LANG_PARSER_STRING_SELECT',      'Випадаючий список з передвстановленими значеннями');
    define('LANG_PARSER_STRING_CHECKBOX',    'Прапор заповненості поля');
    ...
    define('LANG_PARSER_NUMBER_DECIMAL_S',   'Кількість розрядів дробової частини');
    define('LANG_PARSER_NUMBER_TRIM_ZERO',   'Обрізати дробові нулі');
    define('LANG_PARSER_NUMBER_DEC_POINT',   'Розділювач дробової частини');
    define('LANG_PARSER_NUMBER_IS_CEIL',     'Тільки цілі числа');
    define('LANG_PARSER_NUMBER_THOUSANDS_SEP', 'Роздільник тисяч');
    define('LANG_PARSER_NUMBER_UNITS_SEP',   'Відділювач одиниць виміру від числа');
    define('LANG_PARSER_NUMBER_IS_ABS',      'Тільки позитивні числа');
    define('LANG_PARSER_NUMBER_SAVE_ZERO',   'Зберігати нульове значення');
    ...
    define('LANG_PARSER_HTML_EDITOR_GR',     'Редактори HTML для груп');
    ...
    define('LANG_PARSER_LIST_FILTER_MULTICH',  'Відображати множинний вибір чекбоксами');
    ...
    define('LANG_PARSER_FILE_LABEL',         'Заголовок посилання на файл');
    ...
    define('ERR_VALIDATE_URL',               'Невірний формат URL');
    ...
    define('LANG_DOT',                       'Крапка');
    define('LANG_COMMA',                     'Кома');
    define('LANG_SPACE',                     'Пробіл');
    define('LANG_APOSTROPHE',                'Апостроф');
    define('LANG_ANOTHER',                   'Інший');
    ...
    define('LANG_SEO_KEYS',                  'Ключові слова (meta keywords)');
    define('LANG_SEO_KEYS_HINT',             'Ключові слова сторінки, через кому');
    define('LANG_SEO_DESC',                  'Опис (meta description)');
    ...
    define('LANG_POWERED_BY_INSTANTCMS',     'Працює на <a href="https://instantcms.ru/">InstantCMS</a>');
    ...
    define('LANG_DEBUG_TAB_EVENTS_EMPTY',    'Неактивні події');
    define('LANG_DEBUG_TAB_EVENTS',          'Відпрацьовані події');
